...
import { Loader2, User, Mail, Shield, Bell, Key, Check, Calendar, MapPin, Hash, Building2, ArrowRight } from "lucide-react";
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      // Récupération synchrone depuis user_metadata
  ...
  return (
    <div className="min-h-screen bg-[#F7F5F0] text-[#111110] selection:bg-[#111110] selection:text-[#F7F5F0]">
      <main className="mx-auto max-w-6xl px-6 py-12 md:px-12 space-y-10">
        ...
        {/* MISE EN PAGE STRUCTURÉE (Navigation Latérale + Contenu) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          
          {/* Barre latérale (4 colonnes) */}
          <aside className="lg:col-span-4 space-y-2 sticky top-8">
            <div className="rounded-3xl border border-[#111110]/15 bg-white/50 p-3 backdrop-blur-md space-y-1.5 shadow-sm">
              {menuItems.map((item) => {
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {activeSection === "personal" && (
              <section className="rounded-3xl border border-[#111110]/15 bg-white/50 p-6 md:p-8 backdrop-blur-md space-y-6 shadow-sm">
