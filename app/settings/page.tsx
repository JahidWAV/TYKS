  ...
  return (
    <div className="min-h-screen bg-[#F7F5F0] text-[#111110] selection:bg-[#111110] selection:text-[#F7F5F0]">
      <main className="mx-auto max-w-6xl px-6 py-12 md:px-12 space-y-10">
        ...
        {/* MISE EN PAGE FLEXIBLE (Hauteur étirée pour égaliser les deux blocs) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          
          {/* Barre latérale (4 colonnes) - Utilise h-full pour s'ajuster à la ligne */}
          <aside className="lg:col-span-4 flex flex-col">
            <div className="rounded-3xl border border-[#111110]/15 bg-white/50 p-3 backdrop-blur-md space-y-1.5 shadow-sm flex-1 flex flex-col justify-between">
                ...
                {menuItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-start gap-3.5 p-3.5 rounded-2xl transition-all text-left border ${
                        isActive
                    ...
                    >
                      <Icon className={`w-4 h-4 mt-0.5 shrink-0 ${isActive ? "text-[#F7F5F0]" : "opacity-60"}`} />
                      <div className="space-y-0.5 overflow-hidden">
                        <p className={`text-xs font-bold font-mono uppercase tracking-wide ${isActive ? "text-[#F7F5F0]" : "text-[#111110]"}`}>
                          {item.title}
                        </p>
                        <p className={`text-[11px] truncate ${isActive ? "text-[#F7F5F0]/70" : "opacity-50"}`}>
                          {item.desc}
                        </p>
                      </div>
                    </button>
              ...
              <div className="p-4 rounded-2xl bg-[#111110]/5 border border-[#111110]/10 mt-4">
                <p className="text-[11px] font-mono opacity-60">Connecté en tant que</p>
                <p className="text-xs font-bold truncate mt-0.5">{email}</p>
              </div>
            </div>
          </aside>

          {/* Contenu dynamique (8 colonnes) */}
          <div className="lg:col-span-8 flex flex-col">
            ...
            {activeSection === "personal" && (
              <section className="rounded-3xl border border-[#111110]/15 bg-white/50 p-6 md:p-8 backdrop-blur-md space-y-6 shadow-sm flex-1 flex flex-col justify-between">
                <div className="space-y-6">
                  ...
                  <form onSubmit={handleUpdateProfile} id="personal-form" className="space-y-5">
            ...
            {activeSection === "danger" && (
              <section className="rounded-3xl border border-red-500/20 bg-red-500/5 p-6 md:p-8 backdrop-blur-md space-y-6 shadow-sm flex-1 flex flex-col justify-between">
                <div className="space-y-6">
