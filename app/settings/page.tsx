...
import { Loader2, User, Mail, Shield, Bell, Key, CreditCard, Ticket, Globe, Smartphone, Check, AlertCircle } from "lucide-react";
...
export default function SettingsPage() {
  ...
  // Préférences de billetterie & notifications
    ...
    <div className="min-h-screen bg-[#F7F5F0] text-[#111110] selection:bg-[#111110] selection:text-[#F7F5F0]">
      <main className="mx-auto max-w-4xl px-6 py-12 md:px-12 space-y-8">
        <div className="space-y-2 mb-4">
          ...
          <p className="text-xs font-mono opacity-60 uppercase tracking-wider">Gérez vos informations personnelles, méthodes de connexion et préférences</p>
        </div>
        ...
        {/* Section Connexion & Sécurité (Gérant le cas Google) */}
        <section className="rounded-3xl border border-[#111110]/15 bg-white/40 p-6 md:p-8 backdrop-blur-md space-y-6">
          <div className="flex items-center gap-3 border-b border-[#111110]/10 pb-4">
          ...
          <div className="space-y-4">
            ...
            {!isGoogleProvider && (
              <p className="text-[11px] opacity-50 px-1 font-mono">
                Note : Les comptes connectés via Google gèrent leur mot de passe et leur sécurité direttamente depuis les paramètres de votre compte Google.
              </p>
            )}
          </div>
        </section>

        {/* Section Préférences de Billetterie & Notifications */}
        <section className="rounded-3xl border border-[#111110]/15 bg-white/40 p-6 md:p-8 backdrop-blur-md space-y-6">
          <div className="flex items-center gap-3 border-b border-[#111110]/10 pb-4">
        ...
        {/* Section Zone de Danger / Déconnexion des appareils */}
        <section className="rounded-3xl border border-red-500/20 bg-red-500/5 p-6 md:p-8 backdrop-blur-md space-y-4">
