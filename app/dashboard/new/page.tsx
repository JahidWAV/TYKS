...
export default function NewEventPage() {
  ...
  const handleConfirmCrop = async () => {
    try {
      ...
      // Génération d'un slug temporaire basé sur le titre si présent pour le nom du fichier
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white font-grotesque p-4 md:p-8 flex flex-col justify-center">
      <div className="max-w-4xl mx-auto w-full space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-xl font-bold tracking-tight text-white uppercase">Créer un événement</h1>
        </div>

        {error && (
          <div className="rounded-2xl border border-red-500/20 bg-red-950/40 px-5 py-3 text-xs text-red-400 font-bold">
            <span>{error}</span>
          </div>
        )}
        ...
        <div className="rounded-[2.5rem] border border-white/15 bg-[#0f0f0f] p-6 md:p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/15 bg-black px-4 py-3 text-xs text-white focus:outline-none focus:border-white transition-colors"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full rounded-2xl border border-white/15 bg-black px-3 py-3 text-[11px] text-white focus:outline-none focus:border-white transition-colors"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-xs text-white/70 font-bold uppercase tracking-wider flex items-center gap-1.5">
              ...
              {/* Colonne Droite : Description & Image */}
              <div className="space-y-4 flex flex-col justify-between">
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-2xl border border-white/15 bg-black px-4 py-3 text-xs text-white focus:outline-none focus:border-white transition-colors resize-none"
                  />
                </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <button
                        ...
                        className="h-10 px-4 bg-neutral-900 hover:bg-neutral-800 text-white text-xs font-bold uppercase tracking-wider rounded-full border border-white/15 transition-colors inline-flex items-center gap-2 cursor-pointer w-full justify-center"
                      >
            ...
            <div className="flex items-center justify-end pt-4 border-t border-white/10">
              <button
                ...
                className="h-11 px-8 bg-white hover:bg-neutral-200 text-black font-bold text-xs uppercase tracking-wider transition-all duration-300 inline-flex items-center gap-2 rounded-full shadow-lg disabled:opacity-50 cursor-pointer w-full md:w-auto justify-center"
              >
