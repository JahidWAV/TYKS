...
export default function PublicHome() {
  ...
  return (
    <main className="h-[calc(100vh-5rem)] overflow-y-auto snap-y snap-mandatory scroll-smooth bg-[#0f0f0f] text-white selection:bg-white selection:text-black font-grotesque antialiased">
      
      {/* 1. HERO SECTION */}
      <section className="h-full w-full snap-start flex items-center justify-center max-w-7xl mx-auto px-6 lg:px-12">
      ...
      <section id="evenements" className="h-full w-full snap-start flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-12 py-12">
      ...
      {/* 3. SECTION VALEURS */}
      <section className="h-full w-full snap-start flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-12 py-12">
