...
export default function PublicHome() {
  ...
  return (
    <div 
      ...
      className="bg-white text-neutral-950 selection:bg-black selection:text-white font-grotesque antialiased h-screen overflow-y-scroll snap-y snap-mandatory flex flex-col"
    >
      ...
      <main className="w-full flex-1">
        ...
        <section className="h-screen w-full snap-start snap-always flex items-center max-w-7xl mx-auto px-6 lg:px-12 py-12 shrink-0">
          <div className="w-full grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6 flex flex-col justify-center">
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-[1.02] text-neutral-950">
                L&apos;ART DU SPECTACLE, <br />
                SANS ARTIFICE.
              </h1>
              <p className="text-xs sm:text-sm text-neutral-600 max-w-xl font-normal leading-relaxed normal-case">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <a
                  href="#evenements"
                  className="h-12 px-8 bg-neutral-950 hover:bg-neutral-800 text-white font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center justify-center rounded-full shadow-md cursor-pointer"
                >
                  VOIR LA PROGRAMMATION
                </a>
                <a
                  href="https://pro.tyks.fr"
                  className="h-12 px-8 bg-transparent hover:bg-neutral-100 border border-neutral-300 text-neutral-950 font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center justify-center rounded-full cursor-pointer"
                >
                  ESPACE ORGANISATEUR
                </a>
              </div>
            ...
            <div className="lg:col-span-5 flex justify-center w-full">
              <div className="relative w-full max-w-md bg-neutral-50 border border-neutral-200 p-6 sm:p-8 rounded-[2.5rem] shadow-sm space-y-5">
                <div className="flex items-center justify-between border-b border-neutral-200 pb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-neutral-900 border border-neutral-900 flex items-center justify-center text-white">
                      <Smartphone className="w-4 h-4" />
                    </div>
                    <div>
                      <h3 className="text-xs font-bold text-neutral-950">APPLICATION TYKS</h3>
                      <p className="text-[10px] text-neutral-500 font-bold">IOS, ANDROID & WALLET</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                  <div className="space-y-3">
                    <p className="text-xs text-neutral-600 font-normal leading-relaxed normal-case">
                      Emportez vos billets partout avec vous et ajoutez vos passes en un clic dans Apple Wallet.
                    </p>
                    <div className="inline-flex items-center gap-1.5 text-xs text-neutral-900 font-bold bg-white border border-neutral-200 px-3 py-1.5 rounded-xl shadow-xs">
                      <Wallet className="w-3.5 h-3.5" />
                      <span>WALLET SUPPORTÉ</span>
                    </div>
                  </div>

                  <div className="bg-white border border-neutral-200 p-3 rounded-[2rem] flex flex-col items-center justify-center text-center space-y-2 shadow-xs">
                    ...
                    <span className="text-[9px] uppercase tracking-wider text-neutral-500 font-bold">SCANNEZ</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* SECTION ÉVÉNEMENTS */}
        <section id="evenements" className="h-screen w-full snap-start snap-always flex items-center justify-between px-4 sm:px-8 lg:px-12 py-4 shrink-0 relative overflow-hidden bg-neutral-50/50">
          
          <div className="hidden xl:flex items-center justify-center shrink-0 w-16 h-[460px] select-none self-center">
            <span className="text-neutral-950/[0.04] uppercase tracking-[0.2em] text-3xl font-black [writing-mode:vertical-lr] rotate-180 whitespace-nowrap">
          ...
          <div className="flex-1 relative w-full max-w-[1140px] mx-auto px-4 z-10 flex items-center justify-center">
            ...
            {loading ? (
              <div className="w-full bg-white border border-neutral-200 p-12 text-center text-xs text-neutral-500 rounded-[2rem] font-bold">
              ...
              <>
                <button 
                  ...
                  className="hidden md:flex absolute -left-4 lg:-left-12 z-30 w-12 h-12 rounded-full bg-white border border-neutral-300 items-center justify-center text-neutral-950 hover:bg-neutral-950 hover:text-white transition-all shadow-md cursor-pointer"
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="p-5 flex-1 space-y-2 flex flex-col justify-center text-center">
                            <h3 className="text-base font-bold text-neutral-950 tracking-tight group-hover:underline transition-colors line-clamp-1">
                              {evt.title}
                            </h3>
                            
                            {evt.location && (
                              <p className="text-xs text-neutral-600 font-semibold truncate">
                                {evt.location}
                              </p>
                            )}

                            <p className="text-xs text-neutral-400 font-bold uppercase tracking-wider pt-0.5">
                              {dateStr} {timeStr ? `• ${timeStr}` : ''}
                            </p>
                          </div>

                          {/* Bouton */}
                          <div className="flex items-center justify-center border-t border-neutral-100 p-3.5 bg-neutral-50/50">
                            <div className="w-full h-9 px-4 bg-neutral-950 group-hover:bg-neutral-800 text-white font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 rounded-xl shadow-xs">
                ...
                <button 
                  ...
                  className="hidden md:flex absolute -right-4 lg:-right-12 z-30 w-12 h-12 rounded-full bg-white border border-neutral-300 items-center justify-center text-neutral-950 hover:bg-neutral-950 hover:text-white transition-all shadow-md cursor-pointer"
                  aria-label="Suivant"
                >
          ...
          <div className="hidden xl:flex items-center justify-center shrink-0 w-16 h-[460px] select-none self-center">
            <span className="text-neutral-950/[0.04] uppercase tracking-[0.2em] text-3xl font-black [writing-mode:vertical-lr] whitespace-nowrap">
              PROCHAINS ÉVÉNEMENTS
            </span>
          </div>
        ...
        <section className="h-screen w-full snap-start snap-always flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-12 py-12 shrink-0">
          <div className="space-y-12 w-full">
            <div className="text-center max-w-2xl mx-auto space-y-3">
              ...
              <p className="text-xs sm:text-sm text-neutral-600 font-normal normal-case">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-neutral-50 border border-neutral-200 p-6 sm:p-8 rounded-[2.5rem] space-y-4 shadow-xs">
                <div className="w-10 h-10 rounded-2xl bg-neutral-950 text-white flex items-center justify-center">
                  <ShieldCheck className="w-5 h-5 stroke-[1.5]" />
                </div>
                <h3 className="text-lg font-bold text-neutral-950">ZÉRO FRAIS CACHÉS</h3>
                <p className="text-xs text-neutral-600 font-normal leading-relaxed normal-case">
              ...
              <div className="bg-neutral-50 border border-neutral-200 p-6 sm:p-8 rounded-[2.5rem] space-y-4 shadow-xs">
                ...
                <h3 className="text-lg font-bold text-neutral-950">REVENTE SÉCURISÉE</h3>
                <p className="text-xs text-neutral-600 font-normal leading-relaxed normal-case">
              ...
              <div className="bg-neutral-50 border border-neutral-200 p-6 sm:p-8 rounded-[2.5rem] space-y-4 shadow-xs">
                ...
                <h3 className="text-lg font-bold text-neutral-950">SÉLECTION POINTUE</h3>
                <p className="text-xs text-neutral-600 font-normal leading-relaxed normal-case">
        ...
        <section className="h-screen w-full snap-end snap-always flex flex-col justify-between max-w-7xl mx-auto px-6 lg:px-12 pt-12 pb-6 shrink-0">
          <div className="grid lg:grid-cols-2 gap-10 items-center w-full my-auto">
            <div className="space-y-5">
              ...
              <p className="text-xs sm:text-sm text-neutral-600 font-normal leading-relaxed normal-case">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="space-y-1.5">
                  ...
                  <h4 className="text-xs font-bold text-neutral-950">PROPRIÉTÉ DES DONNÉES</h4>
                  <p className="text-[10px] text-neutral-500 font-normal normal-case">Gardez le contact direct avec votre public.</p>
                </div>
                <div className="space-y-1.5">
                  <div className="w-8 h-8 rounded-xl bg-neutral-100 border border-neutral-200 flex items-center justify-center text-neutral-950">
                    <Zap className="w-4 h-4" />
                  </div>
                  <h4 className="text-xs font-bold text-neutral-950">EXPÉRIENCE FLUIDE</h4>
                  <p className="text-[10px] text-neutral-500 font-normal normal-case">Encaissement instantané et passes Wallet.</p>
                </div>
              </div>
            </div>

            <div className="bg-neutral-50 border border-neutral-200 p-8 sm:p-10 rounded-[3rem] space-y-5 shadow-xs text-center lg:text-left">
              <h3 className="text-xl font-bold text-neutral-950">VOUS ORGANISEZ UN ÉVÉNEMENT ?</h3>
              <p className="text-xs sm:text-sm text-neutral-600 font-normal leading-relaxed normal-case">
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a
                  href="https://pro.tyks.fr"
                  className="h-12 px-8 bg-neutral-950 hover:bg-neutral-800 text-white font-bold text-xs uppercase tracking-wider transition-all duration-300 inline-flex items-center justify-center rounded-full shadow-md cursor-pointer"
                >
