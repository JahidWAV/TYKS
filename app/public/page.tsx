...
export default function PublicHome() {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white selection:bg-white selection:text-black font-grotesque antialiased pt-28 uppercase">
      
      {/* HERO SECTION */}
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-24 border-b border-white/10 grid lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-5 flex justify-center w-full">
          <div className="relative w-full max-w-md bg-neutral-900 border border-white/15 p-8 sm:p-10 rounded-[2.5rem] shadow-xl space-y-6">
            <div className="flex items-center justify-between border-b border-white/10 pb-5">
              ...
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-white text-black text-[10px] font-bold tracking-wide uppercase shadow-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="bg-neutral-950 border border-white/15 p-4 rounded-[2rem] flex flex-col items-center justify-center text-center space-y-2.5 shadow-xs">
                <div className="w-24 h-24 bg-neutral-900 rounded-2xl border border-white/15 flex items-center justify-center text-white">
                  <QrCode className="w-14 h-14 opacity-80" />
                </div>
                <span className="text-[10px] uppercase tracking-wider text-white/50 font-bold">SCANNEZ POUR INSTALLER</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* SECTION ÉVÉNEMENTS */}
      <section id="evenements" className="max-w-7xl mx-auto px-6 lg:px-12 py-24 space-y-12 border-b border-white/10">
        ...
        {loading ? (
          <div className="bg-neutral-900 border border-white/15 p-20 text-center text-xs text-white/60 rounded-[2.5rem] font-bold">
            CHARGEMENT DES EXPÉRIENCES EN COURS...
          </div>
        ) : events.length === 0 ? (
          <div className="bg-neutral-900 border border-white/15 p-20 text-center space-y-4 rounded-[2.5rem]">
            <div className="w-14 h-14 mx-auto rounded-2xl bg-white/10 flex items-center justify-center text-white">
                ...
                >
                  ...
                  <div className="relative w-full aspect-square bg-neutral-100 overflow-hidden border-b border-black/10 flex items-center justify-center">
                    ...
                    <div className="absolute top-4 right-4 z-10">
                      <span className="text-[11px] font-bold px-3 py-1 bg-black/80 backdrop-blur-md border border-white/20 text-white rounded-full shadow-xs">
      ...
      {/* SECTION VALEURS */}
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-24 border-b border-white/10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-neutral-900 border border-white/15 p-8 sm:p-10 rounded-[2.5rem] space-y-5 transition-all duration-300 hover:border-white hover:shadow-xl">
            ...
            <h3 className="text-xl font-bold text-white">ZÉRO FRAIS CACHÉS</h3>
          ...
          <div className="bg-neutral-900 border border-white/15 p-8 sm:p-10 rounded-[2.5rem] space-y-5 transition-all duration-300 hover:border-white hover:shadow-xl">
            ...
            <h3 className="text-xl font-bold text-white">REVENTE OFFICIELLE SÉCURISÉE</h3>
            <p className="text-xs sm:text-sm text-white/70 font-normal leading-relaxed normal-case">
          ...
          <div className="bg-neutral-900 border border-white/15 p-8 sm:p-10 rounded-[2.5rem] space-y-5 transition-all duration-300 hover:border-white hover:shadow-xl">
            ...
            <h3 className="text-xl font-bold text-white">SÉLECTION POINTUE</h3>
            <p className="text-xs sm:text-sm text-white/70 font-normal leading-relaxed normal-case">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-24 border-b border-white/10 grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6 pt-4">
            <div className="space-y-2">
              ...
              <h4 className="text-sm font-bold text-white">PROPRIÉTÉ DES DONNÉES</h4>
              <p className="text-[11px] text-white/50 font-normal normal-case">Gardez le contact direct avec votre public et vos fidèles spectateurs.</p>
            </div>
            <div className="space-y-2">
              <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/15 flex items-center justify-center text-white">
                <Zap className="w-5 h-5" />
              </div>
              <h4 className="text-sm font-bold text-white">EXPÉRIENCE FLUIDE</h4>
              <p className="text-[11px] text-white/50 font-normal normal-case">Encaissement instantané et génération automatique des e-billets et passes Wallet.</p>
            </div>
          </div>
        </div>
        <div className="bg-neutral-900 border border-white/15 p-8 sm:p-12 rounded-[3rem] space-y-6 shadow-xl">
          ...
          <div className="pt-2">
            <a
              href="https://pro.tyks.app"
              className="h-12 px-7 bg-white hover:bg-neutral-200 text-black font-bold text-xs uppercase tracking-wider transition-all duration-300 inline-flex items-center justify-center rounded-full shadow-lg cursor-pointer"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="bg-neutral-900 border border-white/20 rounded-[3rem] p-8 sm:p-14 flex flex-col md:flex-row items-center justify-between gap-10 shadow-xl">
          ...
          <a
            href="https://pro.tyks.app"
            className="h-12 px-9 bg-white hover:bg-neutral-200 text-black font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center justify-center rounded-full shadow-lg shrink-0 cursor-pointer"
          >
