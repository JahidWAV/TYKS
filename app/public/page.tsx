...
export default function PublicHome() {
  ...
  return (
    <main className="bg-[#0f0f0f] text-white selection:bg-white selection:text-black font-grotesque antialiased">
      
      {/* 1. HERO SECTION */}
      <section className="min-h-[calc(100vh-5rem)] flex items-center max-w-7xl mx-auto px-6 lg:px-12 py-12 snap-start">
      ...
      <section id="evenements" className="min-h-[calc(100vh-5rem)] flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-12 py-12 snap-start">
      ...
      {/* 3. SECTION VALEURS */}
      <section className="min-h-[calc(100vh-5rem)] flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-12 py-12 snap-start">
