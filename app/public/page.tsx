...
export default function PublicHome() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#721120] text-[#FAF7F2] selection:bg-[#FAF7F2] selection:text-[#721120] font-serif min-h-screen">
      
      {/* ─── 1. HERO SECTION ─── */}
      <section className="relative px-6 md:px-16 pt-24 pb-24 max-w-7xl mx-auto w-full border-b border-[#FAF7F2]/15">
        <div className="max-w-4xl space-y-8">
          <div className="inline-flex items-center gap-2.5 text-xs font-sans tracking-[0.25em] uppercase px-4 py-2 rounded-full bg-[#FAF7F2]/10 text-[#FAF7F2] font-medium border border-[#FAF7F2]/20">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-stretch gap-3 bg-[#5c0e1a] p-3 rounded-2xl md:rounded-full border border-[#FAF7F2]/20 shadow-2xl max-w-3xl">
            ...
            <div className="flex items-center gap-3 px-4 py-3 sm:w-52">
              ...
              <select
                ...
                className="bg-transparent font-sans text-sm focus:outline-none w-full text-[#FAF7F2] cursor-pointer [&>option]:bg-[#5c0e1a] [&>option]:text-[#FAF7F2]"
              >
                {VILLES.map((v) => (
            ...
            <a 
              href="#agenda" 
              className="px-8 py-3.5 bg-[#FAF7F2] text-[#721120] rounded-xl sm:rounded-full font-sans text-xs font-medium uppercase tracking-widest hover:bg-white transition-all flex items-center justify-center gap-2 shadow-sm"
            >
              <span>Chercher</span>
      ...
      <section id="agenda" className="py-24 px-6 md:px-16 max-w-7xl mx-auto w-full">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-xs font-medium tracking-wider uppercase whitespace-nowrap transition-all border ${
                  selectedCategory === cat 
                    ? 'bg-[#FAF7F2] text-[#721120] border-[#FAF7F2]' 
                    : 'bg-[#5c0e1a] text-[#FAF7F2]/80 border-[#FAF7F2]/15 hover:border-[#FAF7F2]/40'
                }`}
              >
                {cat}
              </button>
        ...
        {loading ? (
          ...
          <div className="py-24 text-center border border-[#FAF7F2]/20 rounded-[2.5rem] bg-[#5c0e1a]/50 space-y-4 font-sans">
            ...
            <button 
              ...
              className="mt-2 px-6 py-3 bg-[#FAF7F2] text-[#721120] rounded-full text-xs font-medium uppercase tracking-widest hover:bg-white transition-colors"
            >
            ...
            {filteredEvents.map((item) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-[#5c0e1a] border border-[#FAF7F2]/15 hover:border-[#FAF7F2] rounded-[2.5rem] p-8 flex flex-col justify-between h-[440px] transition-all duration-300 shadow-xl relative overflow-hidden"
                >
                  ...
                  <div className="space-y-4 pt-6 border-t border-[#FAF7F2]/15">
                    ...
                    <div className="w-full py-3.5 rounded-full bg-[#FAF7F2] text-[#721120] group-hover:bg-white transition-colors flex items-center justify-center gap-2 text-xs font-sans font-medium uppercase tracking-widest shadow-sm">
      ...
      <section className="py-24 px-6 md:px-16 bg-[#5c0e1a] border-t border-b border-[#FAF7F2]/15">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 grid md:grid-cols-2 gap-6 font-sans">
            <div className="p-8 rounded-[2.5rem] bg-[#721120] border border-[#FAF7F2]/20 space-y-4 shadow-xl">
              ...
              <p className="text-xs font-light text-[#FAF7F2]/85 leading-relaxed">
      ...
      {/* ─── 4. CTA FINAL ─── */}
      <section className="py-24 px-6 md:px-16 bg-[#721120] text-[#FAF7F2] text-center border-t border-[#FAF7F2]/15">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="pt-4">
            <a
              href="#agenda"
              className="px-8 py-4 rounded-full bg-[#FAF7F2] text-[#721120] hover:bg-white transition-colors text-xs font-sans font-medium uppercase tracking-widest shadow-xl inline-block"
            >
