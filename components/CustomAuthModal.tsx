...
export default function CustomAuthModal({ isOpen, onClose }: CustomAuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md bg-white border border-[#1e3932]/15 p-8 shadow-2xl text-[#1e3932] font-sans rounded-2xl">
        <button
          onClick={onClose}
          ...
          <>
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="w-full h-12 flex items-center justify-center gap-3 px-4 border border-[#1e3932]/15 bg-[#f8faf9] hover:bg-[#1e3932]/5 text-[#1e3932] text-xs font-medium uppercase tracking-wider transition-all disabled:opacity-50 cursor-pointer rounded-xl shadow-sm"
              >
                <svg className="w-4 h-4 fill-current text-[#1e3932]" viewBox="0 0 24 24">
        ...
        {step === 'email' ? (
          ...
          <form onSubmit={handleSubmitAuth} className="space-y-4 animate-in fade-in slide-in-from-right-2 duration-200">
            <div className="flex items-center justify-between px-4 py-3 border border-[#1e3932]/15 bg-[#f8faf9] text-xs rounded-xl text-[#1e3932]">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 font-medium underline text-[#1e3932] hover:opacity-70 cursor-pointer"
              >
