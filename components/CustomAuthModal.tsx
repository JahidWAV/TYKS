  ...
  return (
    ...
    >
      <div className="relative w-full bg-white border border-neutral-950 p-8 shadow-2xl rounded-[2.5rem]">
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 w-9 h-9 border border-neutral-950 bg-white hover:bg-neutral-950 text-neutral-950 hover:text-white flex items-center justify-center transition-all duration-300 cursor-pointer rounded-full shadow-sm"
        >
          <X className="w-4 h-4" />
        </button>
